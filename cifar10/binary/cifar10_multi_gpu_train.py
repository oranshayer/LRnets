...
tf.app.flags.DEFINE_string('train_dir', '/home/oran/logdir/cifar10_binary',"Directory where to write event logs and checkpoint.")
tf.app.flags.DEFINE_integer('epochs', 450, "Number of epochs to run.")
