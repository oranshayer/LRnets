...
tf.app.flags.DEFINE_string('train_dir', '/home/oran/logdir/resnet18_binary_conv1_fp',"""Directory where to write event logs and checkpoint.""")
...
def save_training_params():
    ...
    f.write('First layer binary = ' + str(FLAGS.first_layer_binary) + '\n')
    f.write('Probability clipping = ' + str(FLAGS.clip_probs) + '\n\n')
    f.close()
